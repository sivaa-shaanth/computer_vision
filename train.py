...
parser.add_argument(
    "--train-split", metavar="NAME", default="train", help="dataset train split (default: train)"
)
parser.add_argument(
    "--val-split",
    metavar="NAME",
...
parser.add_argument(
    "--opt", default="adamw", type=str, metavar="OPTIMIZER", help='Optimizer (default: "sgd"'
)
parser.add_argument(
    "--opt-eps",
    default=1e-8,
...
parser.add_argument(
    "--weight-decay", type=float, default=0.05, help="weight decay (default: 2e-5)"
)
parser.add_argument(
    "--clip-grad",
    type=float,
...
parser.add_argument(
    "--lr", type=float, default=5e-4, metavar="LR", help="learning rate (default: 0.05)"
)
parser.add_argument(
    "--lr-noise",
    type=float,
...
parser.add_argument(
    "--bce-loss", action="store_true", default=False, help="Enable BCE loss w/ Mixup/CutMix use."
)
parser.add_argument(
    "--bce-target-thresh",
    type=float,
...
parser.add_argument(
    "--reprob", type=float, default=0.25, metavar="PCT", help="Random erase prob (default: 0.)"
)
parser.add_argument(
...
parser.add_argument(
    "--mixup", type=float, default=0.8, help="mixup alpha, mixup enabled if > 0. (default: 0.)"
)
parser.add_argument(
    "--cutmix", type=float, default=1.0, help="cutmix alpha, cutmix enabled if > 0. (default: 0.)"
)
parser.add_argument(
    "--cutmix-minmax",
    type=float,
...
parser.add_argument(
    "--drop-path", type=float, default=0.2, metavar="PCT", help="Drop path rate (default: None)"
)
parser.add_argument(
...
parser.add_argument(
    "--apex-amp", action="store_true", default=False, help="Use NVIDIA Apex AMP mixed precision"
)
parser.add_argument(
    "--native-amp", action="store_true", default=False, help="Use Native Torch AMP mixed precision"
)
parser.add_argument(
    "--no-ddp-bb",
    action="store_true",
...
parser.add_argument(
    "--channels-last", action="store_true", default=False, help="Use channels_last memory layout"
)
parser.add_argument(
    "--pin-mem",
    action="store_true",
